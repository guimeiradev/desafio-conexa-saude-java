...
import br.com.conexa.imedicina.desafio.dto.response.CustomExceptionDto;
...
public class ExceptionHandlerAdvice extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = { ProfessionalAlreadyInUseException.class })
    protected ResponseEntity<Object> handleConflict(ProfessionalAlreadyInUseException ex, WebRequest request) {
        return handleExceptionInternal(ex, null, new HttpHeaders(), ex.getHttpStatus(), request);
    }
